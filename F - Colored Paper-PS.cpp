...
void solve() {
    ...
    cin>>n;
    /*
        The GF is: (1+x^2/2!+x^4/4!....)(1+x+x^2/2!...)(x+x^3/3!+x^5/5!..)
        we can write the first term as (e^x+e^-x)/2 and last term as (e^x-e^-x)/2:
        The answer thus becomes coefficient of x^n/n! in (e^3x - e^-x)/4
    */
    int ans = 0;
    ans += power(3,n);
    if(n&1){
