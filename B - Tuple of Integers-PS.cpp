...
void solve() {
    cin>>n;
    /*
        since we can write it in polynomial form hence it becomes:
        (1+x)(1+x+x^2)(1+x^2+x^4....)(1+x^3+x^6.....)'s coefficient of x^n
        which on solving becomes 1/(x-1)^2:
        in this the coefficient of x^n can be found using binomial as: n+1 is the answer:
    */
